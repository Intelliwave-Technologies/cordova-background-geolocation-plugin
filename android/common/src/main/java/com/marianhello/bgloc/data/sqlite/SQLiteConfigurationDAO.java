...
public class SQLiteConfigurationDAO implements ConfigurationDAO {
	...
	public Config retrieveConfiguration() throws JSONException {
		...
		String[] columns = {
			...
			ConfigurationEntry.COLUMN_NAME_INTERVAL_OF_SCAN,
			ConfigurationEntry.COLUMN_NAME_INTERVAL_BETWEEN_SCANS,
	...
	private Config hydrate(Cursor c) throws JSONException {
		...
		config.setIntervalOfScan(c.getInt(c.getColumnIndex(ConfigurationEntry.COLUMN_NAME_INTERVAL_OF_SCAN)));
		config.setIntervalBetweenScans(c.getInt(c.getColumnIndex(ConfigurationEntry.COLUMN_NAME_INTERVAL_BETWEEN_SCANS)));
	...
	private ContentValues getContentValues(Config config) throws NullPointerException {
		...
		values.put(ConfigurationEntry.COLUMN_NAME_INTERVAL_OF_SCAN, config.getIntervalOfScan());
		values.put(ConfigurationEntry.COLUMN_NAME_INTERVAL_BETWEEN_SCANS, config.getIntervalBetweenScans());
