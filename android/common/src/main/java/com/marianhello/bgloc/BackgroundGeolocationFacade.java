...
public class BackgroundGeolocationFacade {
	...
	public static CordovaWebView STATIC_WEBVIEW_REFERENCE;
	public BackgroundGeolocationFacade(Context context, PluginDelegate delegate, CordovaWebView webview) {
		mContext = context;
		mDelegate = delegate;
		...
		STATIC_WEBVIEW_REFERENCE = webview;
	}
