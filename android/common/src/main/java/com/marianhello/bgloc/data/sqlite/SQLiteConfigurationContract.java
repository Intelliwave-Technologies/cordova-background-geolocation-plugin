...
public final class SQLiteConfigurationContract {
	...
	public static abstract class ConfigurationEntry implements BaseColumns {
		...
		public static final String COLUMN_NAME_INTERVAL_OF_SCAN = "interval_of_scan";
		public static final String COLUMN_NAME_INTERVAL_BETWEEN_SCANS = "interval_between_scans";
		...
		public static final String SQL_CREATE_CONFIG_TABLE =
			"CREATE TABLE " + ConfigurationEntry.TABLE_NAME + " (" +
				...
				ConfigurationEntry.COLUMN_NAME_INTERVAL_OF_SCAN + INTEGER_TYPE + COMMA_SEP +
				ConfigurationEntry.COLUMN_NAME_INTERVAL_BETWEEN_SCANS + INTEGER_TYPE + COMMA_SEP +
